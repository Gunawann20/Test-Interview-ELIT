...
<div class="container">
    <div class="container-fluid" style="margin-top: 80px">
        <div class="row no-gutters shadow">
            <div class="col-lg-6 p-4" style="background-color: #9561e2">
                <div>
                    <img src="img/logo-elit.png" width="80px">
                </div>
                <div class="py-5 text-white">
                    <h5 class="text-sm-center">Nice to see you again</h5>
                    <h1 class="text-sm-center font-weight-bold">Welcome Back</h1>
                </div>
            </div>
